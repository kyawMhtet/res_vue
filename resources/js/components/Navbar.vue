<template>
    <div class="">
        <nav class="navbar navbar-expand-lg bg-body-tertiary py-2 shadow-sm px-3">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <router-link to="/dishes" class="nav-link"
                                :class="{ active: isActive('/dishes') }">Dishes</router-link>
                        </li>
                        <li class="nav-item">
...
export default {
    ...
    methods: {
        isActive(route) {
            return localStorage.getItem('activeRoute') === route;
        }
    }
}
</script>
